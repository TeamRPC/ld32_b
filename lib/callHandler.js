...
function createHero(req, res) {
    ...
    if (!recordProgress) req.ld32.recordProgress = -1;
    //return reject('didnt see recordProgress in req.ld32');
    
    db.getSquireProgress(callUUID, function(err, recordProgress) {
